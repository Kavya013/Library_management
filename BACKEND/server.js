...
const db = mysql.createConnection({
    host: "bgh6ki5y5q2c0vyybysb-mysql.services.clever-cloud.com",
    user: "uoh3odcdmipmj7kq",
    password: "P5jDXBj4hiET96hqdiMn",
    database: "bgh6ki5y5q2c0vyybysb" // Change the database name to "library"
});
