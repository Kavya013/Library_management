...
function Home() {
    ...
    const handleBorrow = (bookId) => {
        axios.post('https://library-management-0gvn.onrender.com/borrowBook', { id: bookId })
            .then((response) => {
    ...
    const fetchBooks = () => {
        const url = searchQuery
            ? `https://library-management-0gvn.onrender.com/searchBooks?query=${searchQuery}`
            : 'https://library-management-0gvn.onrender.com/getBooks';
